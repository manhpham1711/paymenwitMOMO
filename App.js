 ...
 export default class App extends Component<Props> {
   ...
   onPress = async () => {
     if (!this.state.processing){
       ...
       jsonData.notifyUrl = "https://test-payment.momo.vn/pay/app";
       jsonData.fee = 0;
     ...
     return (
       ...
       <View style={styles.container}>
         <View style={[{backgroundColor: 'transparent', alignItems:'center', justifyContent:'center', height: 100}]}>
             <Image style={{flex:1, width:100, height:100}} source={{uri: ' https://img.mservice.io/momo-payment/icon/images/logo512.png'}}/>
         </View>
